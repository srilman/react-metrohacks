        ...
        return (
        	<div>
	        	<div className="container">
	        		<h1 className="display-1 text-center head">Enter some logistical details</h1>
	        		<br></br>
	        		<h2 className="display-2 head">When are you looking to go?</h2>
		        	<div className="row">
					...
					<br></br>
					<h2 className="display-2 head">What is the budget looking like?</h2>
					<div className="row">
			        	<div className="col-lg-6">
				            <div className="input-group">
					...
					<br></br>
					<h2 className="display-2 head">How many people are going?</h2>
					<div>
			            <div className="input-group">
					...
					<br></br>
					<h2 className="display-2 head">How many places do you want to visit per day?</h2> 
					<div className="row">
						<div className="col-lg-6">
							<div className="input-group">
